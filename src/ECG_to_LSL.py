...
class ECG_to_LSL:
   # 2.1 Initialize ECG sensor
    ...
    def  setCalFactor(self):
        if self.exgRes_24bit:
            exgCalFactor = (((2.42*1000)/self.exgGain['GAIN_1'])/(pow(2,23)-1))
        else:
            exgCalFactor = (((2.42*1000)/(self.exgGain['GAIN_1']*2))/(pow(2,15)-1))
